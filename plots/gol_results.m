...
title("Game of Life Runtime, 3x6 LUT")
...
title("Game of Life Speedup for 3x6 LUT")
...
close all
figure
loglog(num_threads_2, lut_spdup_8192(2:end), 'linewidth', 2)
hold on, grid on
loglog(num_threads_2, lut_spdup_16384(2:end), 'linewidth', 2)
loglog(num_threads_2, lut_spdup_32768(2:end),'linewidth', 2)
loglog(num_threads_2, lut_spdup_65536(2:end),'linewidth', 2)
